...
local function InitBottomCenterPanel()
	...
	local function PlayerCanShop(sourceWidget, canShop)
		...
		if (canShop) then
			...
			GetWidget('item_shop_sign'):Sleep(1, function() GetWidget('item_shop_sign'):SlideY('-2.6h', 250) end)
			...
			GetWidget('item_shop_sign'):SlideY('3h', 250)
		end
	end
...
local function InitBottomSection()
	local function PositionBottomSection() -- Set the position of the minimap, the selected info, attack modifiers, and selected buffs. Fires on script load and game join
		if (not GetCvarBool('ui_minimap_rightside')) then		
			...
			GetWidget('game_selected_info_orders_pos'):SetX('-17.3%')
			...
			GetWidget('game_botright_name_label_0B'):SetX('0')
			...
			GetWidget('game_botright_name_label_1B'):SetX('0')
			...
			GetWidget('game_stash_tip_stash'):SetX('19.88h')
